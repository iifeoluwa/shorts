...
import { ILinkRepository, LinkCreate } from "../interfaces/repository/link.repository";


@Injectable()
export class LinkRepository implements ILinkRepository {
  constructor(@InjectModel(LinkSchema.name) private linkModel: Model<LinkDocument>) { }
